            ...
            <div className="bg-slate-400 border p-8 relative">
                ...
                <form onSubmit={handleSubmit} action="">
                    ...
                    <div className="relative my-4">
                        ...
                        <input value={fullName} onChange={e => useFullName(e.target.value)} autoComplete="on" name="fullName" id="fullName" placeholder="Nguyễn Văn A" className="border text-gray-900 rounded-lg block w-full p-2.5" required="" />
                    </div>
                    <div className="relative my-4">
                    ...
                    <div className="relative my-4">
                        ...
                        <input type="cfpassword" value={cfpassword} onChange={e => useCfPassword(e.target.value)} name="cfpassword" id="cfpassword" autoComplete="on" placeholder="••••••••" className="border text-gray-900 rounded-lg block w-full p-2.5" required="" />
                    </div>
